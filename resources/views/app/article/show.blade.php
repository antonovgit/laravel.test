		...
		<div class="col-12 pb-3">
			...
			<p>
				@foreach ($article->tags as $tag)
					<? //Используем переменную $loop ларавеловского цикла foreach для отображения последнего тега особенным образом: все теги выводятся тег label и | .Последний же тег выводится без данной черты ?>
					@if ($loop->last)
