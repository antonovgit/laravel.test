...
@section('content')
    <div class="row mt-5">
        @foreach($articles as $article)
            <div class="col-4 pb-3"> <? //Статьи будут выводится в три колонки, за это отвечает класс col-4 ?>
                <div class="card">
    ...
    <div class="mx-auto" style="width: max-content;"> {{ $articles->links() }} </div> <? //mx-auto бутстраповский класс для горизонтального выравнивания ?>
@endsection
